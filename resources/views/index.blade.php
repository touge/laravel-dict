...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/touge-laravel-dict/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/touge-laravel-dict/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/touge-laravel-dict/css/ddoc.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/touge-laravel-dict/css/animate.min.css') }}">
</head>
<body>
<div id="wrapper">
    <!-- Sidebar -->
    <nav class="navbar navbar-inverse navbar-fixed-top overlay" id="sidebar-wrapper" role="navigation">
        <h2 class="text-center">数据库表</h2>
...
<script src="{{ asset('vendor/touge-laravel-dict/js/jquery.min.js') }}"></script>
<script src="{{ asset('vendor/touge-laravel-dict/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('vendor/touge-laravel-dict/js/ddoc.js') }}"></script>
</body>
</html>
